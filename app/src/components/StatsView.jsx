...
import { permisLabel, EXAM_PASS, EXAM_SIZE, serieQuizId } from '../lib/helpers.js';
  ...
  return (
    <section className="stats-view">
      ...
      <div className="reset-row">
        ...
        <span className="muted">Format d'entraînement : {EXAM_PASS}/{EXAM_SIZE} pour valider · progression stockée sur cet appareil.</span>
      </div>
    </section>
  );
}

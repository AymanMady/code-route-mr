...
import { shuffle, EXAM_SIZE, EXAM_PASS, EXAM_TIME, examQuizId } from '../lib/helpers.js';
    ...
    <section className="exam-hero">
      <div className="exam-card">
        ...
        <p className="muted">
          ...
          chronomètre de {EXAM_TIME / 60} minutes, <b>pas de correction</b> avant la fin —
          pour te mettre dans les conditions du jour J. Format d'entraînement&nbsp;:
          <b> {EXAM_PASS}/{EXAM_SIZE}</b> pour valider.
        </p>
        <div className="exam-meta">
          <div><span className="big">{size}</span><span className="lbl">questions</span></div>
          <div><span className="big">{EXAM_TIME / 60}:00</span><span className="lbl">chrono</span></div>

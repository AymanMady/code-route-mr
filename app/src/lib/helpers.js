...
// Paliers « permis » et format d'examen : définis dans lib/brand.js
// (source unique de vérité pour tout ce qui est propre au pays).
export { permisLabel, EXAM_SIZE, EXAM_PASS, EXAM_TIME } from './brand.js';
